...
1. 原版游戏画面
   ...
   + ![原版游戏主菜单](/image/original_game_main_menu.jpg)
   
   + ![原版游戏要塞选址](/image/original_choose_fortess_location.jpg)

2. 使用了*[Tergel](http://www.bay12forums.com/smf/index.php?topic=145802.0)*图形包后的游戏画面
   
   + ![Tergel图形包游戏主菜单](/image/tergel_graphic_setgame_main_menu.jpg)
   
   + ![Tergel图形包要塞选址](/image/tergel_graphic_set_choose_fortess_location.jpg)
